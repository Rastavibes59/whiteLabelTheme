    ...
    /* PANEL TYPO */
        ...
        //2. Register new Sections
            ...
            $wp_customize->add_section(
                'footer_section',
                array(
                    'title'        => __('Gestion des textes du pied de page'),
                    'panel'        => 'fonts_panel',
                    'description'  => esc_html__('Modifier la police, la couleur et la taille des textes du pied de page'),
                    'priority'     => 162, // Not typically needed. Default is 160
                    'capability'   => 'edit_theme_options', // Not typically needed. Default is edit_theme_options
                )
            );
        ...
        //4. Finally, we define the control itself (which links a setting to a section and renders the HTML controls)...
            ...
            $wp_customize->add_control(new WP_Customize_Color_Control( //Instantiate the color control class
                ...
                array(
                    ...
                    'priority'   => 10, //Determines the order this control appears in for the specified section
                    'section'    => 'nav_section', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
                )
            ));
            ...
            $wp_customize->add_control(new WP_Customize_Color_Control( //Instantiate the color control class
                ...
                array(
                    ...
                    'priority'   => 10, //Determines the order this control appears in for the specified section
                    'section'    => 'footer_section', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
                )
            ));
...
//3. Finally, we define the control itself (which links a setting to a section and renders the HTML controls)...
    ...
    $wp_customize->get_setting( 'nav_color' )                       ->transport = 'postMessage';
