...
<div class="container grid cols-12 lg-cols-1 gap-15 pt-80 md-pt-50">
    <article class="colspan-9 lg-colspan-1  flex column ">
    ...
    <aside class="colspan-3 lg-colspan-1  flex column">
        <div class="flex column justify-flex-start align-flex-start p-20 blogAside">
            ...
            <div class="flex row justify-space-between align-center w-100 gap-15">
                <div class="flex column justify-flex-start align-center">
                    <p class="size-small mb-00 w-100"><strong>Publié le :</strong> <?php echo get_the_date('d/m/Y'); ?></p>
                    <p class="size-small mb-00 w-100"><strong>Auteur :</strong> <?php echo get_the_author(); ?></p>
                </div>
            </div>
